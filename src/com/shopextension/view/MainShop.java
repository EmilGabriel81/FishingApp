package com.shopextension.view;
...
public class MainShop extends JFrame {
	...
	public MainShop(Controller controller) {
		super("Main Shop");
		this.controller = controller;
		//controller = new Controller();
		//controller.init();// we load the entries in the addEntries()
		...
		placeOrderPanel.setOrderListener(new OrderListener() {
			...
			public void orderEmitted(String name, double size, int quantity) {
				Item item = controller.findTheItem(name, size);// i need to fix the method 
				try {
